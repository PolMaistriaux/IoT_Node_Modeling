...
def deployment_sweep_ebatt  (Replacement_strategy = False,Footprint=None,Node=None,Nyears= 100,dtrans = 10, param = [], paramType =None,nAAmin = 1, nAAmax=6, nAA_step=1,transport_model=None,filename=None,figsize=(7,6)):   
